...
Unittest classes:
    ...
    TestSquareX
    TestSquareY
    TestSquareOrderOfInitialization
    TestSquareArea
    TestSquareStdout
...
class TestSquareInstantiation(unittest.TestCase):
    ...
    def test_one_argument(self):
        sqr = Square(10)
        sqr2 = Square(11)
        self.assertEqual(sqr.id, sqr2.id - 1)
    ...
    def test_size_private_attribute(self):
...
class TestSquareX(unittest.TestCase):
    """Test cases for the initialization of the x attribute in the Square class."""
...
class TestSquareY(unittest.TestCase):
    """Test cases for the initialization of the y attribute in the Square class."""
...
class TestSquareInitializationOrder(unittest.TestCase):
    """Test cases for the order of initialization of Square attributes."""
    ...
    def test_invalid_x_before_y(self):
        with self.assertRaisesRegex(TypeError, "X-coordinate must be an integer"):
...
class TestSquareStrAndDisplay(unittest.TestCase):
    """Test cases for the __str__ and display methods of the Square class."""
    ...
    def test_str_print_size(self):
        s = Square(4)
        capture = TestSquareStrAndDisplay.capture_stdout(s, "print")
    ...
    def test_display_size(self):
        s = Square(2, 0, 0, 9)
        capture = TestSquareStrAndDisplay.capture_stdout(s, "display")
        self.assertEqual("##\n##\n", capture.getvalue())
...
class TestSquareUpdateArgs(unittest.TestCase):
    ...
    def test_update_width_setter(self):
        s = Square(10, 10, 10, 10)
        s.update(89, 2)
        self.assertEqual(2, s.width)

    def test_update_height_setter(self):
        s = Square(10, 10, 10, 10)
        s.update(89, 2)
...
class TestSquareUpdateKwargs(unittest.TestCase):
    """Test cases for the update method using keyword arguments of the Square class."""
    ...
    def test_update_width_setter_kwarg(self):
        s = Square(10, 10, 10, 10)
        s.update(id=89, size=8)
        self.assertEqual(8, s.width)

    def test_update_height_setter_kwarg(self):
        s = Square(10, 10, 10, 10)
    ...
    def test_update_None_id_and_more_kwargs(self):
        s = Square(10, 10, 10, 10)
    ...
    def test_update_size_zero_kwarg(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            s.update(size=0)

    def test_update_size_negative_kwarg(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            s.update(size=-3)
    ...
    def test_update_x_negative_kwarg(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "x must be >= 0"):
            s.update(x=-5)
    ...
    def test_update_y_negative_kwarg(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "y must be >= 0"):
            s.update(y=-5)
    ...
    def test_update_wrong_keys_kwargs(self):
        s = Square(10, 10, 10, 10)
        s.update(a=5, b=10)
        self.assertEqual("[Square] (10) 10/10 - 10", str(s))

    def test_update_some_wrong_keys_kwargs(self):
        s = Square(10, 10, 10, 10)
...
class TestSquareToDictionary(unittest.TestCase):
    ...
    def test_to_dictionary_invalid_arg(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaises(TypeError):
            s.to_dictionary(1)
